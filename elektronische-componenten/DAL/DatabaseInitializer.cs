...
namespace elektronische_componenten.DAL
{
    public class DatabaseInitializer : DropCreateDatabaseAlways<ComponentContext>
    {
        protected override void Seed(ComponentContext context)
        {
            ...
            context.Componenten.Add(new Component("Modulairstekker Stekker, recht RJ12 Aantal polen: 6P6C P 128 Transparant Lumberg Inhoud: 1 stuks", c1,
            ...
            context.Componenten.Add(new Component("BKL Electronic 10120098 USB-stekker voor zelfbouw Type A (A-USBPA-N) Stekker, recht 1 stuks", c1,
            ...
            context.Componenten.Add(new Component("ABL Sursum Geaarde rubberen stekker zwart", c1,
                "http://www.conrad.be/ce/nl/product/552646/ABL-Sursum-Geaarde-rubberen-stekker-zwart/?ref=category&rt=category&rb=1",
                2, 2.99));

            context.Componenten.Add(new Component("Goobay Netwerk Aansluitkabel CAT 5e U/UTP 2 m Grijs", c2,
            ...
            context.Componenten.Add(new Component("LAS2GQF-11ZE/R/12V/N/P Vandalismebestendige drukschakelaar 250 V/DC 3 A 1x aan/aan IP67 vergrendelend 1 stuks", c4,
            ...
            context.Componenten.Add(new Component("KN3 Tuimelschakelaar 250 V/AC 3 A 2x aan/uit/aan vergrendelend/0/vergrendelend 1 stuks", c4,
